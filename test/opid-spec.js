...
describe("OPID", function() {
  ...
  describe("configuration", function() {
    ...
    it("Could make good use of instantiation with config, unlike node-uuid that takes config for each call" , function() {
  ...
  describe("#woot", function() {
    ...
    it("Uses the same ID as uuid (hence the use for instantiation)", function() {
